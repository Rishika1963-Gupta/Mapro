...
async function loadProducts() {
    const response = await fetch('/.vscode/products2.json');
    ...
    products.forEach(product => {
        ...
        card.className = 'prd-nm p-4 prd-result border rounded-lg overflow-hidden shadow-lg shadow-gray-600 hover:bg-rose-700  cursor-pointer';
        card.innerHTML = `
            <div class="prd-img">
